...
<head>
  ...
  <title>KFC România - Pagina Demo</title>
...
<?php endif; ?>
  ...
  <section class="banner">
    <div class="banner-text">
      <h1>Gustul Original KFC</h1>
      <p>Descoperă cele mai delicioase meniuri de pui crocant!</p>
      <a href="produse.html" class="btn">Vezi Meniul</a>
    </div>
  </section>

  <!-- CONȚINUT PRINCIPAL + ASIDE -->
  <main class="main-grid">
    ...
    <section class="produse">
      ...
      <div class="produse-grid">
        <div class="produs">
          <img src="https://api.kfc.ro/uploads/Imagine_Card_664x496_a0f1c4bd8e.png" alt="Meniu 1">
          <h3>Marți Bucket</h3>
          <p><span class="pret-redus">Preț: 32,90 lei</span></p>
          <a href="#" class="btn-small">Detalii</a>
        </div>

        <div class="produs">
          <img src="https://api.kfc.ro/uploads/meniu_kentucky_d77c30cedf.jpg" alt="Meniu 2">
        ...
        <div class="produs">
          <img src="https://api.kfc.ro/uploads/non_spicy_bucket_e613b4ef59.jpg" alt="Meniu 3">
    ...
    <!-- ASIDE -->
    <aside class="sidebar">
      <h2>Știri & Curiozități</h2>
      <div class="aside-card">
        <img src="aripioare.jpg" height="250" width="300" alt="Aripioare">
        <p>Rețeta originală a Colonelului Sanders conține 11 condimente secrete!</p>
      </div>

      <div class="aside-card">
        <img src="zinger_1024x1024@2x.jpg" height="250" width="300" alt="Zinger">
        <p>Încearcă Zinger Burger – crocant, picant și absolut legendar!</p>
      </div>
    </aside>
