...
MODEL_CLASS_FILE = os.path.join(PROJECT_ROOT, "src", "neural_network", "model_cnc_multiclass.keras")
MODEL_RUL_FILE   = os.path.join(PROJECT_ROOT, "src", "neural_network", "rul", "model_cnc_regression.keras")
SCALER_FILE      = os.path.join(PROJECT_ROOT, "src", "neural_network", "scaler_cnc.pkl")
ENCODERS_FILE    = os.path.join(PROJECT_ROOT, "src", "neural_network", "encoders_cnc.pkl")
TARGET_ENCODER_FILE = os.path.join(PROJECT_ROOT, "src", "neural_network", "target_encoder.pkl")
