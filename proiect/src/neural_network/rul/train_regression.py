...
TRAIN_FILE = os.path.join(PROJECT_ROOT, "data", "train", "train.csv")
VAL_FILE   = os.path.join(PROJECT_ROOT, "data", "validation", "val.csv")

MODEL_FILE  = os.path.join(BASE_DIR, "model_cnc_regression.keras")
SCALER_FILE = os.path.join(BASE_DIR, "scaler_reg.pkl")
ENCODER_FILE = os.path.join(BASE_DIR, "encoder_reg.pkl")
